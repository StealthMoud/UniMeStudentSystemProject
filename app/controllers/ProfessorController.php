...
class ProfessorController extends Controller {
    ...
    public function chooseCourses(): void
    {
        Session::init();
        $this->authorize('professor');
    ...
    public function viewCourses(): void
    {
        ...
        $courses = $courseModel->getApprovedAndAssignedCoursesByProfessor($professorId);
    ...
    public function scheduleLecture(): void
    {
        Session::init();
        $courseModel = $this->model('Course');
    ...
    public function enterGrades(): void
    {
        Session::init();
        $this->authorize('professor');
