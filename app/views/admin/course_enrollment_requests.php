...
<html>
<head>
    <title>Course Enrollment Requests</title>
    <style>
        body {
...
<body>
<div class="container">
    <h1>Course Enrollment Requests</h1>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($request['status'] === 'pending'): ?>
                            <form method="post" action="<?php echo BASE_URL; ?>?url=admin/updateCourseEnrollmentRequestStatus">
